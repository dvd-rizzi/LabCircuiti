...
void voltage_function(double R, double L, double C, double R_L, double R_v) {
    ...
    v_function->SetParameter(0, 100);
    v_function->SetParameter(1, 470*10e-6);
    v_function->SetParameter(2, 10e-6);
    v_function->SetParameter(3, 2.5);
    v_function->SetParameter(4, 50);
